...
if __name__ == "__main__":
    ...
    src_collection_id = "<enter value>"
    tgt_collection_id = "<enter value>"
    filter_setup = {"and": [{"collectionId": src_collection_id}, {"assetType": "Azure Data Lake Storage Gen2"}]}
    ...
    print(query_list)
    print("Total #assets to be moved:", len(query_list))
    ...
    for iter in range(start, end, batch_size):
        ...
        print("Moving:", len(batch))
        client.collections.move_entities(guids=batch, collection=tgt_collection_id, api_version="2022-03-01-preview")
